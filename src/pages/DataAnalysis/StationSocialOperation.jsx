...
const columns = [
  ...
  { key: 'openTime', title: '开放时间', width: 'w-20', tip: '默认从站点基础表的营业时间拆分获取，可在本表修改。' },
  { key: 'closeTime', title: '关闭时间', width: 'w-20', tip: '默认从站点基础表的营业时间拆分获取，可在本表修改。' },
    ...
    <div className="page-container h-full flex flex-col min-w-0 overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <ReportFieldControls fields={reportFields} onExport={handleExport} exportFileName={`单站社会运营明细表_${selectedMonth}.xlsx`} />
        </div>
      </div>
