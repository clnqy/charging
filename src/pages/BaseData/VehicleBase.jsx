...
const baseColumns = [
  ...
  { key: 'vehicleNo', name: '车辆编号', width: 130, fixed: true, required: true },
...
const initialVehicles = [
  ['陈家桥公交充电站', 'BUS-202601', '渝A12345D', '大学城1路', '重庆公交集团', '西部公交分公司', 862000, '公交客车', '2021-03-12', 5, 'XML6855JEVJ0C', 'LZYTATE68M1000012', 80, 10500, 2550, 3200, '厦门金龙联合汽车工业有限公司', '运营', '有效'],
  ['福佑路公交枢纽站', 'BUS-202602', '渝A23567D', '160路', '重庆公交集团', '北部公交分公司', 915000, '公交客车', '2022-08-18', 4, 'BYD6100LGEV9', 'LGXCH6CD7N2000431', 82, 10490, 2500, 3300, '比亚迪汽车工业有限公司', '运营', '有效'],
  ['五里店公交站', 'BUS-202603', '渝A88901D', '638路', '重庆公交集团', '江北公交分公司', 798000, '公交客车', '2020-11-03', 6, 'ZK6856BEVG3', 'LZYTATE63L1000877', 76, 8540, 2450, 3180, '郑州宇通客车股份有限公司', '维修', '有效'],
  ['南坪公交充电站', 'BUS-202604', '渝B11220D', '305路', '重庆公交集团', '南部公交分公司', 875000, '公交客车', '2023-05-21', 3, 'XML6105JEVW0C', 'LZYTATE66P1000456', 80, 10490, 2550, 3260, '厦门金龙联合汽车工业有限公司', '停运', '无效'],
  ['菜园坝公交充电站', 'BUS-202605', '渝A66778D', '皇冠大扶梯线', '重庆公交集团', '渝中公交分公司', 688000, '中巴客车', '2019-09-30', 7, 'BJ6851EVCA', 'LVCC6B2B4K9002781', 58, 8495, 2450, 3150, '北汽福田汽车股份有限公司', '运营', '有效'],
  ['观音桥公交充电站', 'BUS-202606', '渝A90123D', '818路', '重庆公交集团', '江北公交分公司', 938000, '双层客车', '2024-01-09', 2, 'ZK6125CHEVNPG4', 'LZYTATE68R1000066', 92, 11980, 2550, 3600, '郑州宇通客车股份有限公司', '运营', '有效'],
].map((row, index) => ({
  id: index + 1,
  stationName: row[0],
  vehicleNo: row[1],
